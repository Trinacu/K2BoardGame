...
class Menu(tools.States):
    def __init__(self, screen_rect):
        ...
        self.options = ['Play', 'View Cards', 'Options', 'Quit']
        self.next_list = ['GAME', 'CARDVIEW', 'OPTIONS']
        self.title, self.title_rect = tools.make_text('K2 climb', self.title_color, (self.screen_rect.centerx, 120), 150)
    ...
    def render(self, screen):
        ...
        for i,opt in enumerate(self.rendered["des"]):
            opt[1].center = (self.screen_rect.centerx, self.from_top+i*self.spacer)
